 ...
 */
package aplikasi.view.menu.masuk;
 ...
 * @author dhiskar
 */
public class DataMasukView extends javax.swing.JInternalFrame {
    ...
    public DataMasukView(MainMenuView menuController, Users p) {
        initComponents();
    ...
    private void setField(Peminjaman pinjam) {
        try {
            ...
            Logger.getLogger(DataMasukView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        if (areAllNotEmpty(daftarPengembalianDeatil, txtKode.getText(), txtTanggal.getDateFormatString())) {
            try {
                ...
                DataMasukView view = new DataMasukView(menuController, p);
    ...
    private void btnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariActionPerformed
        DataKeluar view = new DataKeluar(menuController, this, true);
