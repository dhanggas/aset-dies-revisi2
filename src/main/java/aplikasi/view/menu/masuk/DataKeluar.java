 ...
 * @author dhiskar
 */
public class DataKeluar extends javax.swing.JDialog {

    private final DataMasukView pengembalianController;
     ...
     * @param parent
     */
    DataKeluar(java.awt.Frame parent, DataMasukView pengembalianController, boolean modal) {
        super(parent, modal);
        initComponents();
