 ...
 * @author dhiskar
 */
public class DataKeluarView extends javax.swing.JInternalFrame {
     ...
     */
    public DataKeluarView(MainMenuView menuController, Users p) {
        ...
        try {
            ...
            Logger.getLogger(DataKeluarView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
 ...
 private void textFieldLimit() {
        ...
        if (areAllNotEmpty(daftarPeminjaman, txtKode.getText(), txtNamaPembawa.getText())) {
            try {
                ...
                if (JOptionPane.showConfirmDialog(this, "Data yang telah di simpan tidak dapat di ubah.\nSimpan data ?", getTitle(),
                    ...
                    DataKeluarView view = new DataKeluarView(menuController, p);
    ...
    private void btnTambahAsetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahAsetActionPerformed
        DetailKeluarView view = new DetailKeluarView(menuController, this, peminjaman, true);
