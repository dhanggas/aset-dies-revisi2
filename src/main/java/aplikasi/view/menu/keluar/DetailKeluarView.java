 ...
 * @author dhiskar
 */
public class DetailKeluarView extends javax.swing.JDialog {
    ...
    private final DataKeluarView dataPeminjamanVIewController;
     ...
     * @param modal
     */
    public DetailKeluarView(java.awt.Frame parent, DataKeluarView dataPeminjamanVIewController, Peminjaman peminjaman, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void refrestDataTable() {
        try {
            ...
            Logger.getLogger(DetailKeluarView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
